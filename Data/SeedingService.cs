...
namespace ProjetoWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r5 = new SalesRecord(5, new DateTime(2018, 09, 21), 6000.0, SaleStatus.Billed, s3);
            SalesRecord r6 = new SalesRecord(6, new DateTime(2018, 09, 6), 3000.0, SaleStatus.Billed, s6);
            SalesRecord r7 = new SalesRecord(7, new DateTime(2018, 09, 12), 4000.0, SaleStatus.Billed, s2);
